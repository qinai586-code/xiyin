...
| **P1** (A→B) | Persona Compiler + Snapshot; templates out of code; per-turn selection and budget (first step: ✅ v4 arm, tendencies and motivations out of speech, §7.3 turn move with one decision line; see the 2026-09-23 Windows diagnosis); exemplar experiment | Snapshot version on every generation; probes non-inferior to v2; budget met |
