...
PROTOCOL_VERSION = "phase1.l4_gateway_contract.v1"
...
def validate_l4_contract():
    return {
        ...
        "network_listener_allowed": NETWORK_LISTENER_ALLOWED,
        "external_platform_binding_allowed": EXTERNAL_PLATFORM_BINDING_ALLOWED,
